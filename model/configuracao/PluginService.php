...
use classes\db_db_itensmenu;
use classes\db_db_permissao;
use classes\db_db_menu;
use classes\db_db_pluginitensmenu;
...
class PluginService {
  ...
  private function salvarMenus($oItemMenu, $iPlugin, $iModulo, $iMenuPai = null) {
    ...
    $oDaoDbitensmenu = new db_db_itensmenu();
    $oDaoDbpermissao = new db_db_permissao();
    $oDaoDbmenu      = new db_db_menu();
    $oDaoPluginMenu  = new db_db_pluginitensmenu();
  ...
  private function salvarModulo($oModulo, $oPlugin) {
    ...
    $oDaoDbModulo = new db_db_modulos();
    $oDaoPluginModulo = new db_db_pluginmodulos();
    $oDaoDbItensmenu = new db_db_itensmenu();
    $oDaoDbMenu = new db_db_menu();
  ...
  private function getModulosPlugin(Plugin $oPlugin) {
    ...
    $oDaoPluginModulos  = new db_db_pluginmodulos();
  ...
  public function getItensMenuPlugin(Plugin $oPlugin) {
    ...
    $oDaoPluginItensMenu  = new db_db_pluginitensmenu();
