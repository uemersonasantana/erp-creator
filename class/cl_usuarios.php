...
class cl_usuarios {
   ...
   function cl_db_usuarios() {
     ...
     $this->rotulo = new \std\rotulo("db_usuarios");
   ...
   function incluir ($id_usuario){
     ...
     if($id_usuario == "" || $id_usuario == null ){
       $result = db_stdlib::db_query("select nextval('db_usuarios_id_usuario_seq')");
       if($result==false){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,570,'','".AddSlashes(pg_result($resaco,0,'nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,571,'','".AddSlashes(pg_result($resaco,0,'login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,572,'','".AddSlashes(pg_result($resaco,0,'senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,573,'','".AddSlashes(pg_result($resaco,0,'usuarioativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,574,'','".AddSlashes(pg_result($resaco,0,'email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,3598,'','".AddSlashes(pg_result($resaco,0,'usuext'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,12093,'','".AddSlashes(pg_result($resaco,0,'administrador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,20639,'','".AddSlashes(pg_result($resaco,0,'datatoken'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,109,21606,'','".AddSlashes(pg_result($resaco,0,'dataexpira'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["id_usuario"]) || $this->id_usuario != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,568,'".AddSlashes(pg_result($resaco,$conresaco,'id_usuario'))."','$this->id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["nome"]) || $this->nome != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,570,'".AddSlashes(pg_result($resaco,$conresaco,'nome'))."','$this->nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["login"]) || $this->login != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,571,'".AddSlashes(pg_result($resaco,$conresaco,'login'))."','$this->login',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["senha"]) || $this->senha != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,572,'".AddSlashes(pg_result($resaco,$conresaco,'senha'))."','$this->senha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["usuarioativo"]) || $this->usuarioativo != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,573,'".AddSlashes(pg_result($resaco,$conresaco,'usuarioativo'))."','$this->usuarioativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["email"]) || $this->email != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,574,'".AddSlashes(pg_result($resaco,$conresaco,'email'))."','$this->email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["usuext"]) || $this->usuext != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,3598,'".AddSlashes(pg_result($resaco,$conresaco,'usuext'))."','$this->usuext',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["administrador"]) || $this->administrador != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,12093,'".AddSlashes(pg_result($resaco,$conresaco,'administrador'))."','$this->administrador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["datatoken"]) || $this->datatoken != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,20639,'".AddSlashes(pg_result($resaco,$conresaco,'datatoken'))."','$this->datatoken',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["dataexpira"]) || $this->dataexpira != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,109,21606,'".AddSlashes(pg_result($resaco,$conresaco,'dataexpira'))."','$this->dataexpira',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_stdlib::db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,570,'','".AddSlashes(pg_result($resaco,$iresaco,'nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,571,'','".AddSlashes(pg_result($resaco,$iresaco,'login'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,572,'','".AddSlashes(pg_result($resaco,$iresaco,'senha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,573,'','".AddSlashes(pg_result($resaco,$iresaco,'usuarioativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,574,'','".AddSlashes(pg_result($resaco,$iresaco,'email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,3598,'','".AddSlashes(pg_result($resaco,$iresaco,'usuext'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,12093,'','".AddSlashes(pg_result($resaco,$iresaco,'administrador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,20639,'','".AddSlashes(pg_result($resaco,$iresaco,'datatoken'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,109,21606,'','".AddSlashes(pg_result($resaco,$iresaco,'dataexpira'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
