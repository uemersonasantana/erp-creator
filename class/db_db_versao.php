...
class db_db_versao { 
   ...
   function __construct() { 
     ...
     $this->rotulo          =   new \std\rotulo("db_versao"); 
   ...
   function incluir ($db30_codver){ 
     ...
     if($db30_codver == "" || $db30_codver == null ){
       $result = db_stdlib::db_query("select nextval('db_versao_db30_codver_seq')"); 
       if($result==false){
       ...
       $this->db30_codver = db_stdlib::lastInsertId(); 
     }else{
       $result = db_stdlib::db_query("select last_value from db_versao_db30_codver_seq");
       if(($result != false) && (db_stdlib::lastInsertId() < $db30_codver)){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_stdlib::db_query("insert into db_acountkey values($acount,5867,'$this->db30_codver','I')");
       $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5867,'','".AddSlashes(pg_result($resaco,0,'db30_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5868,'','".AddSlashes(pg_result($resaco,0,'db30_codversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5869,'','".AddSlashes(pg_result($resaco,0,'db30_codrelease'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5870,'','".AddSlashes(pg_result($resaco,0,'db30_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5871,'','".AddSlashes(pg_result($resaco,0,'db30_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($db30_codver=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         $acount = db_stdlib::lastInsertId();
         $resac = db_stdlib::db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
         $resac = db_stdlib::db_query("insert into db_acountkey values($acount,5867,'$this->db30_codver','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codver"]))
           $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5867,'".AddSlashes(pg_result($resaco,$conresaco,'db30_codver'))."','$this->db30_codver',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codversao"]))
           $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5868,'".AddSlashes(pg_result($resaco,$conresaco,'db30_codversao'))."','$this->db30_codversao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_codrelease"]))
           $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5869,'".AddSlashes(pg_result($resaco,$conresaco,'db30_codrelease'))."','$this->db30_codrelease',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_data"]))
           $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5870,'".AddSlashes(pg_result($resaco,$conresaco,'db30_data'))."','$this->db30_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["db30_obs"]))
           $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5871,'".AddSlashes(pg_result($resaco,$conresaco,'db30_obs'))."','$this->db30_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_stdlib::db_query($sql);
     if($result==false){ 
   ...
   function excluir ($db30_codver=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $acount = db_stdlib::lastInsertId();
         $resac = db_stdlib::db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
         $resac = db_stdlib::db_query("insert into db_acountkey values($acount,5867,'$db30_codver','E')");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5867,'','".AddSlashes(pg_result($resaco,$iresaco,'db30_codver'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5868,'','".AddSlashes(pg_result($resaco,$iresaco,'db30_codversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5869,'','".AddSlashes(pg_result($resaco,$iresaco,'db30_codrelease'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5870,'','".AddSlashes(pg_result($resaco,$iresaco,'db30_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,939,5871,'','".AddSlashes(pg_result($resaco,$iresaco,'db30_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
