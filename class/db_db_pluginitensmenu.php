...
class db_db_pluginitensmenu { 
   ...
   function incluir ($db146_sequencial){ 
     ...
     if($db146_sequencial == "" || $db146_sequencial == null ){
       $result = db_stdlib::db_query("select nextval('db_pluginitensmenu_db146_sequencial_seq')"); 
       if($result==false){
       ...
       $result = db_stdlib::db_query("select last_value from db_pluginitensmenu_db146_sequencial_seq");
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_stdlib::db_query("insert into db_acountkey values($acount,20427,'$this->db146_sequencial','I')");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20427,'','".AddSlashes(pg_result($resaco,0,'db146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20434,'','".AddSlashes(pg_result($resaco,0,'db146_db_plugin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20435,'','".AddSlashes(pg_result($resaco,0,'db146_db_itensmenu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,21696,'','".AddSlashes(pg_result($resaco,0,'db146_uid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           $acount = pg_result($resac,0,0);
           $resac = db_stdlib::db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
           $resac = db_stdlib::db_query("insert into db_acountkey values($acount,20427,'$this->db146_sequencial','A')");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_sequencial"]) || $this->db146_sequencial != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20427,'".AddSlashes(pg_result($resaco,$conresaco,'db146_sequencial'))."','$this->db146_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_db_plugin"]) || $this->db146_db_plugin != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20434,'".AddSlashes(pg_result($resaco,$conresaco,'db146_db_plugin'))."','$this->db146_db_plugin',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_db_itensmenu"]) || $this->db146_db_itensmenu != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,20435,'".AddSlashes(pg_result($resaco,$conresaco,'db146_db_itensmenu'))."','$this->db146_db_itensmenu',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["db146_uid"]) || $this->db146_uid != "")
             $resac = db_stdlib::db_query("insert into db_acount values($acount,3673,21696,'".AddSlashes(pg_result($resaco,$conresaco,'db146_uid'))."','$this->db146_uid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_stdlib::db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $acount = pg_result($resac,0,0);
           $resac  = db_stdlib::db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
           $resac  = db_stdlib::db_query("insert into db_acountkey values($acount,20427,'$db146_sequencial','E')");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,3673,20427,'','".AddSlashes(pg_result($resaco,$iresaco,'db146_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,3673,20434,'','".AddSlashes(pg_result($resaco,$iresaco,'db146_db_plugin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,3673,20435,'','".AddSlashes(pg_result($resaco,$iresaco,'db146_db_itensmenu'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_stdlib::db_query("insert into db_acount values($acount,3673,21696,'','".AddSlashes(pg_result($resaco,$iresaco,'db146_uid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
