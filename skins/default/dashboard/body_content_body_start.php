<div class="content-body">
	<section class="card">
        <div id="invoice-template" class="card-body">
        	<!-- Modal -->
            <div id="xlarge" class="modal fade text-left" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true" style="z-index: 1051;">
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                      <div id="modal1_conteudo" class="modal-body" style="padding:5px;padding-top:10px;"></div>
                    </div>
                    <!--<div class="modal-content">
