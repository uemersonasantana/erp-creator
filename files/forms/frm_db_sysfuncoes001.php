...
function js_pesquisa() {
  js_OpenJanelaIframe_Novo('#modal1_conteudo','<?php echo $Services_Funcoes->url_acesso(); ?>files/dbforms/func_db_sysfuncoes001.php?funcao_js=parent.js_retornopesquisa|0', '100%', '580px');
}
