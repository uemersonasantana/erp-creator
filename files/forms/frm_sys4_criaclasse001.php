  ...
  <form class="form" method="post" name="form1" id="form1" action="<?php echo $Services_Funcoes->url_acesso_in().$pagina; ?>">
    ...
    <div class="row match-height">
      <div class="col-md-5">
        <div class="card">
          <div class="form-body">
            <h4 class="form-section"><i class="ft-flag"></i> Gera Classes em PHP</h4>
            
            <?php if ( !isset($_REQUEST["b_estrut"]) ) { ?>

            <div class="form-group">
              <div class="form-check">
                  <input class="form-check-input" style="cursor:pointer;" type="radio" name="tabmod" id="tabmod1" value="m">
                  <label class="form-check-label" style="cursor:pointer;" for="tabmod1"><strong>Módulo</strong></label>
              </div>
              <div class="form-check">
                  <input class="form-check-input" style="cursor:pointer;" type="radio" name="tabmod" id="tabmod0" value="t">
                  <label class="form-check-label" style="cursor:pointer;" for="tabmod0"><strong>Tabela</strong></label>
              </div>
            </div>

            <div class="form-group">
              <input type="text" name="nometab" id="nometab" class="form-control" value="<?=@$nometabela?>">
            </div>

          </div>

          <div class="form-actions">
            <input type="submit" name="b_estrut" id="id_estrut" class="btn btn-dark" value="Criar Classe PHP">
          </div>
