                      ...
                      <div class="form-body">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-2">
                                      <div class="form-group">
                                        ...
                                        <?php $db_funcoes->db_input('tamanho', 3, '', true, 'text', $db_opcao); ?>
                                      </div>
                                  </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="form-check">
                                  <input name="vnulo" id="vnulo" class="form-check-input" type="checkbox" value="" <?=(@$nulo=='t'?'checked':'')?>>
                                  <label class="form-check-label" for="vnulo"><strong>Aceita Nulo</strong></label>
                                </div>
                                <div class="form-check">
                                  <input name="vmaiusculo" id="vmaiusculo" class="form-check-input" type="checkbox" value="" <?=(@$maiusculo=='t'?'checked':'')?>>
                                  <label class="form-check-label" for="vmaiusculo"><strong>Maísculo</strong></label>
                                </div>
                                <div class="form-check">
                                  <input name="autocompl" id="autocompl" class="form-check-input" type="checkbox" value="" <?=(@$nulo=='t'?'checked':'')?>>
