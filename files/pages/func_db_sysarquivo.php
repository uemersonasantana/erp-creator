      ...
      <form class="form form-horizontal" name="form2">
          ...
          <div class="form-body">
              <div class="form-group row" style="margin-bottom:0;">
                  <label class="col-md-3 label-control" for="projectinput5" title="<?=$Tcodmod?>"><?=$Lcodarq?></label>
                  <div class="col-md-9">
          ...
          <div class="form-body">
              <div class="form-group row" style="margin-bottom:0;">
                  <label class="col-md-3 label-control" for="projectinput5" title="<?=$Tnomemod?>"><?=$Lnomearq?></label>
                  <div class="col-md-9">
      ...
      <td align="center" valign="top"> 
        <?php
          if( !isset($pesquisa_chave) ) {
            ...
            $db_stdlib->db_lovrot($sql,15,"()","",$funcao_js);
          }else{
